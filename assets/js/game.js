...
var startGame = function() {
  ...
  for (var i = 0; i < enemyNames.length; i++) {
    ...
    if (playerHealth > 0) {
      ...
      // if were not at hte last enemy in the array
...
var endGame = function() {
  if (playerHealth > 0){
    window.alert("Great job! You have a balance of " + playerMoney + " .")
  } else {
    window.alert("You've lost your robot in battle. Sowrrrryyyyy")
  }
